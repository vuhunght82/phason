    ...
    if (isLoading) {
      return (
        <div className="flex flex-col items-center justify-center h-full text-content-200">
          ...
          <p className="mt-4 text-lg">AI đang pha màu...</p>
        </div>
      );
    }
    ...
    if (!formula) {
      return (
        <div className="flex flex-col items-center justify-center h-full text-content-200">
          ...
          <p className="text-lg">Công thức của bạn sẽ hiện ở đây.</p>
          <p className="text-sm text-center">Hoàn thành các bước để bắt đầu.</p>
        </div>
      );
    }
    ...
    return (
      <div className="space-y-4">
        <div className="flex items-center gap-4 p-3 bg-base-300 rounded-lg">
          ...
          <div>
            <p className="text-sm text-content-200">Công thức cho</p>
